...
from apps.corecode.models import Categoria, CategoriaNova, Citizenship,DirecaoAlocacao, DireccaoDepartamento, Estacao,FuncaoChefia
...
def employee_list(request):
    ...
    direccaodp  = DireccaoDepartamento.objects.all()
...
def editFuncionario(request):
    ...
    funcionario.estacao = estacao
    funcionario.direccaoDepart= direccaoDepart
